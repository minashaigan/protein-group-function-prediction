...
$path = $ARGV[0];
open (GO, "<$path/MF_cursim_table_Rel.txt") || die "Cannot open GO\n";
open (MF, "<$path/annotation_mf.txt") || die "Cannot open MF\n";

open (OUT, ">$path/Human_MF_pairwise_spec_sens_score.txt");
